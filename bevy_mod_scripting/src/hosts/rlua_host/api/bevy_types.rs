...
impl_lua_newtypes!{
...

    {
        ...
        impl {
            static fn "new" => |_,(x,y) : (f32,f32)| Ok(LuaVec2::new(Vec2::new(x,y)));
    ...
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z) : (f32,f32,f32)| Ok(LuaVec3::new(Vec3::new(x,y,z)));
    ...
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (f32,f32,f32,f32)| Ok(LuaVec4::new(Vec4::new(x,y,z,w)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y) : (f64,f64)| Ok(LuaDVec2::new(DVec2::new(x,y)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z) : (f64,f64,f64)| Ok(LuaDVec3::new(DVec3::new(x,y,z)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (f64,f64,f64,f64)| Ok(LuaDVec4::new(DVec4::new(x,y,z,w)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y) : (i32,i32)| Ok(LuaIVec2::new(IVec2::new(x,y)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z) : (i32,i32,i32)| Ok(LuaIVec3::new(IVec3::new(x,y,z)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (i32,i32,i32,i32)| Ok(LuaIVec4::new(IVec4::new(x,y,z,w)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y) : (u32,u32)| Ok(LuaUVec2::new(UVec2::new(x,y)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z) : (u32,u32,u32)| Ok(LuaUVec3::new(UVec3::new(x,y,z)));
        }
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (u32,u32,u32,u32)| Ok(LuaUVec4::new(UVec4::new(x,y,z,w)));
        }
    },
    // --------------------------- Matrices --------------------------- //
    {
        ...
        impl{       
            static fn "new" => |_,(x,y,z) : (LuaVec3,LuaVec3,LuaVec3)| Ok(LuaMat3::new(Mat3::from_cols(x.inner(),y.inner(),z.inner())));
    ...
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (LuaVec4,LuaVec4,LuaVec4,LuaVec4)| Ok(LuaMat4::new(Mat4::from_cols(x.inner(),y.inner(),z.inner(),w.inner())));
       }
    },
    {
    ...
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (LuaDVec4,LuaDVec4,LuaDVec4,LuaDVec4)| Ok(LuaDMat4 ::new(DMat4::from_cols(x.inner(),y.inner(),z.inner(),w.inner())));
        }
    },
    // --------------------------- Quats --------------------------- //
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (f32,f32,f32,f32)| Ok(LuaQuat::new(Quat::from_xyzw(x,y,z,w)));
    ...
    },
    {
        ...
        impl {
            static fn "new" => |_,(x,y,z,w) : (f64,f64,f64,f64)| Ok(LuaDQuat::new(DQuat::from_xyzw(x,y,z,w)));
        }
    },
    {
