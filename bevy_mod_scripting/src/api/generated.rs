...
use crate::{
    api::ValueIndex, APIProvider, LuaDocFragment, LuaProxyable, ReflectPathElem, ReflectedValue,
    ReflectionError, RegisterForeignLuaType, ScriptRef,
};
...
impl tealr::mlu::ExportInstances for BevyAPIGlobals {
    fn add_instances<'lua, T: tealr::mlu::InstanceCollector<'lua>>(
        ...
        instances.add_instance(
            "AnimationPlayer".into(),
            tealr::mlu::UserDataProxy::<LuaAnimationPlayer>::new,
        )?;
        ...
        instances.add_instance(
            "CubemapVisibleEntities".into(),
            tealr::mlu::UserDataProxy::<LuaCubemapVisibleEntities>::new,
        )?;
        ...
        instances.add_instance(
            "VisibleEntities".into(),
            tealr::mlu::UserDataProxy::<LuaVisibleEntities>::new,
        )?;
        instances.add_instance(
        ...
        instances.add_instance(
            "CubemapFrusta".into(),
            tealr::mlu::UserDataProxy::<LuaCubemapFrusta>::new,
        )?;
        instances.add_instance(
            "Frustum".into(),
        ...
        instances.add_instance(
            "RenderTarget".into(),
            tealr::mlu::UserDataProxy::<LuaRenderTarget>::new,
        )?;
        instances.add_instance(
            "Projection".into(),
            tealr::mlu::UserDataProxy::<LuaProjection>::new,
        )?;
        instances.add_instance(
            "OrthographicProjection".into(),
            tealr::mlu::UserDataProxy::<LuaOrthographicProjection>::new,
        )?;
        instances.add_instance(
            "PerspectiveProjection".into(),
            tealr::mlu::UserDataProxy::<LuaPerspectiveProjection>::new,
        )?;
        instances.add_instance(
            "AssetPathId".into(),
            tealr::mlu::UserDataProxy::<LuaAssetPathId>::new,
        )?;
...
impl APIProvider for LuaBevyAPIProvider {
    ...
    fn get_doc_fragment(&self) -> Option<Self::DocTarget> {
        Some(LuaDocFragment::new(|tw| {
            tw.process_type::<LuaAlignContent>()
