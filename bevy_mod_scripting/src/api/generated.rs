...
},
{
    ...
    glam::f32::sse2::vec4::Vec4 : Reflect:
...
},
{
    ...
    glam::f32::sse2::mat4::Mat4 : Reflect:
...
},
{
    ...
    glam::f32::sse2::quat::Quat : Reflect:
        UnaryOps(
			Neg self
			) 
		+ BinOps(
