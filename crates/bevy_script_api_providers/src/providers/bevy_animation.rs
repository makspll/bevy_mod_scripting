...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::Keyframes",
functions[r#"
...
"#,
    ...
    fn clone(&self) -> bevy_animation::prelude::Keyframes;
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::VariableCurve",
functions[r#"
...
"#,
    ...
    #[lua(as_trait = "std::clone::Clone", kind = "Method", output(proxy))]
    fn clone(&self) -> bevy_animation::prelude::VariableCurve;
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::Interpolation",
functions[r#"

    #[lua(as_trait = "std::clone::Clone", kind = "Method", output(proxy))]
    fn clone(&self) -> bevy_animation::prelude::Interpolation;
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::EntityPath",
functions[r#"
...
"#,
    ...
    #[lua(as_trait = "std::clone::Clone", kind = "Method", output(proxy))]
    fn clone(&self) -> bevy_animation::prelude::EntityPath;
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::AnimationClip",
functions[r#"
...
/// Add a [`VariableCurve`] to an [`EntityPath`].
    ...
    fn add_curve_to_path(
        &mut self,
        #[proxy]
        path: bevy_animation::prelude::EntityPath,
        #[proxy]
        curve: bevy_animation::prelude::VariableCurve,
    ) -> ();
...
"#,
    ...
    #[lua(as_trait = "std::clone::Clone", kind = "Method", output(proxy))]
    fn clone(&self) -> bevy_animation::prelude::AnimationClip;
...
pub struct LuaAnimationClip{
        ...
        curves:std::vec::Vec<std::vec::Vec<bevy_animation::prelude::VariableCurvestd::alloc::Global>std::alloc::Global>,


    
        paths:bevy_utils::hashbrown::HashMap<bevy_animation::prelude::EntityPathusizestd::hash::BuildHasherDefault<bevy_utils::AHasher>allocator_api2::stable::alloc::global::Global>,
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::RepeatAnimation",
functions[r#"
...
"#,
    ...
    #[lua(as_trait = "std::clone::Clone", kind = "Method", output(proxy))]
    fn clone(&self) -> bevy_animation::RepeatAnimation;
...
pub struct LuaPlayingAnimation{
        ...
        animation_clip:bevy_asset::Handle<bevy_animation::prelude::AnimationClip>,


    
        path_cache:std::vec::Vec<std::vec::Vec<std::option::Option<bevy_ecs::entity::Entity>std::alloc::Global>std::alloc::Global>,
...
#[proxy(
derive(clone,debug),
remote="bevy_animation::prelude::AnimationPlayer",
functions[r#"
...
/// Repetition behavior of the animation.
    ...
    fn repeat_mode(&self) -> bevy_animation::RepeatAnimation;
...
pub struct LuaAnimationPlayer{
        ...
        transitions:std::vec::Vec<AnimationTransitionstd::alloc::Global>,
...
impl bevy_mod_scripting_core::hosts::APIProvider for BevyAnimationAPIProvider {
    ...
    fn register_with_app(&self, app: &mut bevy::app::App) {
        ...
        app.register_foreign_lua_type::<bevy_animation::prelude::Keyframes>();
        
        app.register_foreign_lua_type::<bevy_animation::prelude::VariableCurve>();
        
        app.register_foreign_lua_type::<bevy_animation::prelude::Interpolation>();
        
        app.register_foreign_lua_type::<bevy_animation::prelude::EntityPath>();
        
        app.register_foreign_lua_type::<bevy_animation::prelude::AnimationClip>();
        
        app.register_foreign_lua_type::<bevy_animation::RepeatAnimation>();
        
        app.register_foreign_lua_type::<PlayingAnimation>();
        
        app.register_foreign_lua_type::<bevy_animation::prelude::AnimationPlayer>();
