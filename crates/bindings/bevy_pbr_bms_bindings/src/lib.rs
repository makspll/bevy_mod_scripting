...
pub(crate) fn register_parallax_mapping_method_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            ...
            |mut _self: R<::bevy_pbr::ParallaxMappingMethod>| {
                let output: () = {
                    {
        ...
        .register_documented(
            ...
            |
                mut _self: R<::bevy_pbr::ParallaxMappingMethod>,
                mut other: R<::bevy_pbr::ParallaxMappingMethod>|
            {
                let output: bool = {
                    {
...
pub(crate) fn register_standard_material_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::StandardMaterial>| {
        ...
        .register_documented(
            "flipped",
            |
                mut _self: V<::bevy_pbr::StandardMaterial>,
                horizontal: bool,
                vertical: bool|
            {
                let output: V<::bevy_pbr::StandardMaterial> = {
...
pub(crate) fn register_default_opaque_renderer_method_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::DefaultOpaqueRendererMethod>| {
...
pub(crate) fn register_wireframe_material_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::wireframe::WireframeMaterial>| {
...
pub(crate) fn register_mesh_3_d_wireframe_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "assert_receiver_is_total_eq",
            |mut _self: R<::bevy_pbr::wireframe::Mesh3dWireframe>| {
                let output: () = {
                    {
        ...
        .register_documented(
            ...
            |
                mut _self: R<::bevy_pbr::wireframe::Mesh3dWireframe>,
                mut other: R<::bevy_pbr::wireframe::Mesh3dWireframe>|
            {
                let output: bool = {
                    {
...
pub(crate) fn register_atmosphere_mode_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::AtmosphereMode>| {
...
pub(crate) fn register_render_visible_mesh_entities_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::RenderVisibleMeshEntities>| {
                let output: V<::bevy_pbr::RenderVisibleMeshEntities> = {
                    {
                        let output: V<::bevy_pbr::RenderVisibleMeshEntities> = <::bevy_pbr::RenderVisibleMeshEntities as ::std::clone::Clone>::clone(
                                &_self,
                            )
                            .into();
                        output
        ...
        .register_documented(
            ...
            |_self: R<::bevy_pbr::RenderCubemapVisibleEntities>| {
                let output: V<::bevy_pbr::RenderCubemapVisibleEntities> = {
                    {
                        let output: V<::bevy_pbr::RenderCubemapVisibleEntities> = <::bevy_pbr::RenderCubemapVisibleEntities as ::std::clone::Clone>::clone(
                                &_self,
                            )
                            .into();
                        output
        ...
        .register_documented(
            ...
            |_self: R<::bevy_pbr::RenderCascadesVisibleEntities>| {
                let output: V<::bevy_pbr::RenderCascadesVisibleEntities> = {
                    {
                        let output: V<::bevy_pbr::RenderCascadesVisibleEntities> = <::bevy_pbr::RenderCascadesVisibleEntities as ::std::clone::Clone>::clone(
                                &_self,
                            )
                            .into();
                        output
...
pub(crate) fn register_opaque_renderer_method_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::OpaqueRendererMethod>| {
                let output: V<::bevy_pbr::OpaqueRendererMethod> = {
                    {
                        let output: V<::bevy_pbr::OpaqueRendererMethod> = <::bevy_pbr::OpaqueRendererMethod as ::std::clone::Clone>::clone(
                                &_self,
                            )
                            .into();
                        output
        ...
        .register_documented(
            ...
            |
                mut _self: R<::bevy_pbr::OpaqueRendererMethod>,
                mut other: R<::bevy_pbr::OpaqueRendererMethod>|
            {
                let output: bool = {
                    {
...
pub(crate) fn register_material_binding_id_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::MaterialBindingId>| {
...
pub(crate) fn register_material_bind_group_slot_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "clone",
            |mut _self: R<::bevy_pbr::MaterialBindGroupSlot>| {
        ...
        .register_documented(
            ...
            |
                mut _self: R<::bevy_pbr::MaterialBindGroupSlot>,
                mut other: R<::bevy_pbr::MaterialBindGroupSlot>|
            {
                let output: bool = {
                    {
...
pub(crate) fn register_material_bind_group_index_functions(world: &mut World) {
    ...
    >::new(world)
        .register_documented(
            "assert_receiver_is_total_eq",
            |mut _self: R<::bevy_pbr::MaterialBindGroupIndex>| {
                let output: () = {
                    {
        ...
        .register_documented(
            ...
            |
                mut _self: R<::bevy_pbr::MaterialBindGroupIndex>,
                mut other: R<::bevy_pbr::MaterialBindGroupIndex>|
            {
                let output: bool = {
                    {
