...
pub(crate) fn register_clustered_decal_functions(world: &mut World) {
    ...
    .register_documented(
        "clone",
        |_self: Ref<::bevy_light::cluster::ClusteredDecal>| {
            let output: Val<::bevy_light::cluster::ClusteredDecal> = {
                {
                    let output: Val<::bevy_light::cluster::ClusteredDecal> =
                        <::bevy_light::cluster::ClusteredDecal as ::std::clone::Clone>::clone(
                            &_self,
                        )
                        .into();
                    output
...
pub(crate) fn register_cascade_shadow_config_functions(world: &mut World) {
    ...
    .register_documented(
        "clone",
        |_self: Ref<::bevy_light::cascade::CascadeShadowConfig>| {
            let output: Val<::bevy_light::cascade::CascadeShadowConfig> = {
                {
                    let output: Val<::bevy_light::cascade::CascadeShadowConfig> =
                        <::bevy_light::cascade::CascadeShadowConfig as ::std::clone::Clone>::clone(
                            &_self,
                        )
                        .into();
                    output
...
pub(crate) fn register_cascades_functions(world: &mut World) {
    ...
    .register_documented(
        "clone",
        |_self: Ref<::bevy_light::cascade::Cascades>| {
            let output: Val<::bevy_light::cascade::Cascades> = {
                {
                    let output: Val<::bevy_light::cascade::Cascades> =
                        <::bevy_light::cascade::Cascades as ::std::clone::Clone>::clone(&_self)
                            .into();
                    output
                }
            };
...
pub(crate) fn register_not_shadow_caster_functions(world: &mut World) {
    ...
    .register_documented(
        "eq",
        |_self: Ref<::bevy_light::NotShadowCaster>, other: Ref<::bevy_light::NotShadowCaster>| {
            let output: bool = {
                {
