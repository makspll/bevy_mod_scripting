...
pub(crate) fn register_color_material_functions(world: &mut World) {
    bevy_mod_scripting_bindings::function::namespace::NamespaceBuilder::<
        ::bevy_sprite_render::prelude::ColorMaterial,
    >::new(world)
        .register_documented(
            "clone",
            |_self: Ref<::bevy_sprite_render::prelude::ColorMaterial>| {
                let output: Val<::bevy_sprite_render::prelude::ColorMaterial> = {
                    {
                        let output: Val<::bevy_sprite_render::prelude::ColorMaterial> = <::bevy_sprite_render::prelude::ColorMaterial as ::std::clone::Clone>::clone(
                                &_self,
                            )
                            .into();
                        output
        ...
        |_self: Ref<::bevy_sprite_render::AlphaMode2d>,
         other: Ref<::bevy_sprite_render::AlphaMode2d>| {
            let output: bool = {
                {
                    let output: bool =
                        <::bevy_sprite_render::AlphaMode2d as ::std::cmp::PartialEq<
                            ::bevy_sprite_render::AlphaMode2d,
                        >>::eq(&_self, &other)
                        .into();
                    output
