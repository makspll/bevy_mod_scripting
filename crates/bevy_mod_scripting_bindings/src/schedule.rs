...
mod tests {
    ...
    fn test_reflect_system_names() {
        ...
        assert_eq!(
            system.path(),
            "bevy_mod_scripting_bindings::schedule::tests::test_system_generic<alloc::string::String>"
        );
        ...
        assert_eq!(
            system.path(),
            "bevy_mod_scripting_bindings::schedule::tests::test_system"
        );
    }
        ...
        T: ScheduleLabel + std::hash::Hash + Eq + Clone + Send + Sync + 'static,
    {
        ...
        let resolve_name = |node_id: NodeId| {
            ...
            // trim module path
            let trim = "bevy_mod_scripting_bindings::schedule::tests::";
            out.replace(trim, "")
        };
