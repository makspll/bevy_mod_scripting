...
/// ```
    ...
    #[lua()]
    fn pause(_self: Mut<bevy::time::prelude::Timer>) -> ();
...
/// ```
    ...
    #[lua()]
    fn unpause(_self: Mut<bevy::time::prelude::Timer>) -> ();
...
/// ```
    ...
    #[lua()]
    fn reset(_self: Mut<bevy::time::prelude::Timer>) -> ();
...
/// ```
    ...
    #[lua()]
    fn pause(_self: Mut<bevy::time::Stopwatch>) -> ();
...
/// ```
    ...
    #[lua()]
    fn unpause(_self: Mut<bevy::time::Stopwatch>) -> ();
...
/// ```
    ...
    #[lua()]
    fn reset(_self: Mut<bevy::time::Stopwatch>) -> ();
...
"#,
    ...
    #[lua(
        as_trait = "std::cmp::PartialEq::<bevy::time::Stopwatch>",
        composite = "eq",
        metamethod = "Eq",
    )]
