                    ...
                    let output: Val<::bevy_input::mouse::AccumulatedMouseMotion> = {
                        {
                            let output: Val<
                                ::bevy_input::mouse::AccumulatedMouseMotion,
                            > = <::bevy_input::mouse::AccumulatedMouseMotion as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input::mouse::AccumulatedMouseScroll> = {
                        {
                            let output: Val<
                                ::bevy_input::mouse::AccumulatedMouseScroll,
                            > = <::bevy_input::mouse::AccumulatedMouseScroll as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input::gamepad::GamepadConnectionEvent> = {
                        {
                            let output: Val<
                                ::bevy_input::gamepad::GamepadConnectionEvent,
                            > = <::bevy_input::gamepad::GamepadConnectionEvent as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input::gamepad::GamepadRumbleRequest> = {
                        {
                            let output: Val<
                                ::bevy_input::gamepad::GamepadRumbleRequest,
                            > = <::bevy_input::gamepad::GamepadRumbleRequest as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
        ...
        >::new(world)
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_input::ButtonState>| {
                    let output: bool = {
                        {
                            let output: bool = ::bevy_input::ButtonState::is_pressed(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input::gamepad::GamepadRumbleIntensity> = {
                        {
                            let output: Val<
                                ::bevy_input::gamepad::GamepadRumbleIntensity,
                            > = <::bevy_input::gamepad::GamepadRumbleIntensity as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
