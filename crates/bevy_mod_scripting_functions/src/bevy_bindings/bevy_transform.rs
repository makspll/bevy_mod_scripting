                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = <::bevy_transform::components::GlobalTransform as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::from_isometry(
                                    iso.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::from_rotation(
                                    rotation.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::from_scale(
                                    scale.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::from_translation(
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::from_xyz(
                                    x,
                                    y,
                                    z,
                                )
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = <::bevy_transform::components::GlobalTransform as ::core::ops::Mul<
                                ::bevy_transform::components::GlobalTransform,
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = ::bevy_transform::components::GlobalTransform::mul_transform(
                                    &_self,
                    ...
                    let output: Val<::bevy_transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                ::bevy_transform::components::GlobalTransform,
                            > = <::bevy_transform::components::Transform as ::core::ops::Mul<
                                ::bevy_transform::components::GlobalTransform,
                            >>::mul(_self.into_inner(), global_transform.into_inner())
                                .into();
                            output
