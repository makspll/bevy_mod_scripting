    ...
    pub(crate) fn register_global_transform_functions(
        ...
        >::new(world)
            ...
            .register_documented(
                "clone",
                |_self: Ref<bevy::transform::components::GlobalTransform>| {
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = <bevy::transform::components::GlobalTransform as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::from_isometry(
                                    iso.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::from_rotation(
                                    rotation.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::from_scale(
                                    scale.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::from_translation(
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::from_xyz(
                                    x,
                                    y,
                                    z,
                                )
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = <bevy::transform::components::GlobalTransform as ::core::ops::Mul<
                                bevy::transform::components::GlobalTransform,
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = bevy::transform::components::GlobalTransform::mul_transform(
                                    &_self,
    ...
    pub(crate) fn register_transform_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::transform::components::Transform,
        >::new(world)
            .register_documented(
                    ...
                    let output: Val<bevy::transform::components::GlobalTransform> = {
                        {
                            let output: Val<
                                bevy::transform::components::GlobalTransform,
                            > = <bevy::transform::components::Transform as ::core::ops::Mul<
                                bevy::transform::components::GlobalTransform,
                            >>::mul(_self.into_inner(), global_transform.into_inner())
                                .into();
                            output
    ...
    pub(crate) fn register_transform_tree_changed_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::transform::components::TransformTreeChanged>| {
                    let output: Val<bevy::transform::components::TransformTreeChanged> = {
                        {
                            let output: Val<
                                bevy::transform::components::TransformTreeChanged,
                            > = <bevy::transform::components::TransformTreeChanged as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
