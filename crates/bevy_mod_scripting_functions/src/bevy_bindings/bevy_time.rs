            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_time::prelude::Fixed>| {
                    let output: Val<::bevy_time::prelude::Fixed> = {
                        {
                            let output: Val<::bevy_time::prelude::Fixed> = <::bevy_time::prelude::Fixed as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_time::prelude::Real>| {
                    let output: Val<::bevy_time::prelude::Real> = {
                        {
                            let output: Val<::bevy_time::prelude::Real> = <::bevy_time::prelude::Real as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
        ...
        >::new(world)
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_time::prelude::Timer>| {
                    let output: bool = {
                        {
                            let output: bool = ::bevy_time::prelude::Timer::finished(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_time::prelude::Timer>| {
                    let output: f32 = {
                        {
                            let output: f32 = ::bevy_time::prelude::Timer::fraction(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |mut _self: Mut<::bevy_time::prelude::Timer>| {
                    let output: () = {
                        {
                            let output: () = ::bevy_time::prelude::Timer::pause(
                                    &mut _self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_time::prelude::Timer>| {
                    let output: bool = {
                        {
                            let output: bool = ::bevy_time::prelude::Timer::paused(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |mut _self: Mut<::bevy_time::prelude::Timer>| {
                    let output: () = {
                        {
                            let output: () = ::bevy_time::prelude::Timer::reset(
                                    &mut _self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |mut _self: Mut<::bevy_time::prelude::Timer>| {
                    let output: () = {
                        {
                            let output: () = ::bevy_time::prelude::Timer::unpause(
                                    &mut _self,
                                )
                                .into();
                            output
