...
impl bevy::time::prelude::Fixed {
    ...
    fn clone (_self:Ref<bevy::time::prelude::Fixed>,) -> Val<bevy::time::prelude::Fixed> {
        let output: Val<bevy::time::prelude::Fixed> =<bevy::time::prelude::Fixed as ::core::clone::Clone>::clone(&_self,).into();
        output
    }
...
impl bevy::time::prelude::Real {
    ...
    fn clone (_self:Ref<bevy::time::prelude::Real>,) -> Val<bevy::time::prelude::Real> {
        let output: Val<bevy::time::prelude::Real> =<bevy::time::prelude::Real as ::core::clone::Clone>::clone(&_self,).into();
        output
    }
...
impl bevy::time::prelude::Timer {
    ...
    fn assert_receiver_is_total_eq (_self:Ref<bevy::time::prelude::Timer>,) -> () {
        let output: () =<bevy::time::prelude::Timer as ::core::cmp::Eq>::assert_receiver_is_total_eq(&_self,).into();
        output
    }
    ...
    fn clone (_self:Ref<bevy::time::prelude::Timer>,) -> Val<bevy::time::prelude::Timer> {
        let output: Val<bevy::time::prelude::Timer> =<bevy::time::prelude::Timer as ::core::clone::Clone>::clone(&_self,).into();
        output
    }
    ...
    fn duration (_self:Ref<bevy::time::prelude::Timer>,) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> =bevy::time::prelude::Timer::duration(&_self,).into();
        output
    }
    ...
    fn elapsed (_self:Ref<bevy::time::prelude::Timer>,) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> =bevy::time::prelude::Timer::elapsed(&_self,).into();
        output
    }
    ...
    fn eq (_self:Ref<bevy::time::prelude::Timer>,other:Ref<bevy::time::prelude::Timer>,) -> bool {
        let output: bool =<bevy::time::prelude::Timer as ::core::cmp::PartialEq::<bevy::time::prelude::Timer>>::eq(&_self,&other,).into();
        output
    }
    ...
    fn from_seconds (duration:f32,mode:Val<bevy::time::prelude::TimerMode>,) -> Val<bevy::time::prelude::Timer> {
        let output: Val<bevy::time::prelude::Timer> =bevy::time::prelude::Timer::from_seconds(duration,mode.into_inner(),).into();
        output
    }
    ...
    fn mode (_self:Ref<bevy::time::prelude::Timer>,) -> Val<bevy::time::prelude::TimerMode> {
        let output: Val<bevy::time::prelude::TimerMode> =bevy::time::prelude::Timer::mode(&_self,).into();
        output
    }
    ...
    fn new (duration:Val<::core::time::Duration>,mode:Val<bevy::time::prelude::TimerMode>,) -> Val<bevy::time::prelude::Timer> {
        let output: Val<bevy::time::prelude::Timer> =bevy::time::prelude::Timer::new(duration.into_inner(),mode.into_inner(),).into();
        output
    }
    ...
    fn remaining (_self:Ref<bevy::time::prelude::Timer>,) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> =bevy::time::prelude::Timer::remaining(&_self,).into();
        output
    }
    ...
    fn set_duration (mut _self:Mut<bevy::time::prelude::Timer>,duration:Val<::core::time::Duration>,) -> () {
        let output: () =bevy::time::prelude::Timer::set_duration(&mut _self,duration.into_inner(),).into();
        output
    }
    ...
    fn set_elapsed (mut _self:Mut<bevy::time::prelude::Timer>,time:Val<::core::time::Duration>,) -> () {
        let output: () =bevy::time::prelude::Timer::set_elapsed(&mut _self,time.into_inner(),).into();
        output
    }
    ...
    fn set_mode (mut _self:Mut<bevy::time::prelude::Timer>,mode:Val<bevy::time::prelude::TimerMode>,) -> () {
        let output: () =bevy::time::prelude::Timer::set_mode(&mut _self,mode.into_inner(),).into();
        output
    }
    ...
    fn times_finished_this_tick (_self:Ref<bevy::time::prelude::Timer>,) -> u32 {
        let output: u32 =bevy::time::prelude::Timer::times_finished_this_tick(&_self,).into();
        output
    }
...
impl bevy::time::prelude::TimerMode {
    ...
    fn assert_receiver_is_total_eq (_self:Ref<bevy::time::prelude::TimerMode>,) -> () {
        let output: () =<bevy::time::prelude::TimerMode as ::core::cmp::Eq>::assert_receiver_is_total_eq(&_self,).into();
        output
    }


    
    fn clone (_self:Ref<bevy::time::prelude::TimerMode>,) -> Val<bevy::time::prelude::TimerMode> {
        let output: Val<bevy::time::prelude::TimerMode> =<bevy::time::prelude::TimerMode as ::core::clone::Clone>::clone(&_self,).into();
        output
    }


    
    fn eq (_self:Ref<bevy::time::prelude::TimerMode>,other:Ref<bevy::time::prelude::TimerMode>,) -> bool {
        let output: bool =<bevy::time::prelude::TimerMode as ::core::cmp::PartialEq::<bevy::time::prelude::TimerMode>>::eq(&_self,&other,).into();
        output
    }
...
impl bevy::time::prelude::Virtual {
    ...
    fn clone (_self:Ref<bevy::time::prelude::Virtual>,) -> Val<bevy::time::prelude::Virtual> {
        let output: Val<bevy::time::prelude::Virtual> =<bevy::time::prelude::Virtual as ::core::clone::Clone>::clone(&_self,).into();
        output
    }
...
impl bevy::time::Stopwatch {
    ...
    fn assert_receiver_is_total_eq (_self:Ref<bevy::time::Stopwatch>,) -> () {
        let output: () =<bevy::time::Stopwatch as ::core::cmp::Eq>::assert_receiver_is_total_eq(&_self,).into();
        output
    }
    ...
    fn clone (_self:Ref<bevy::time::Stopwatch>,) -> Val<bevy::time::Stopwatch> {
        let output: Val<bevy::time::Stopwatch> =<bevy::time::Stopwatch as ::core::clone::Clone>::clone(&_self,).into();
        output
    }
    ...
    fn elapsed (_self:Ref<bevy::time::Stopwatch>,) -> Val<::core::time::Duration> {
        let output: Val<::core::time::Duration> =bevy::time::Stopwatch::elapsed(&_self,).into();
        output
    }
    ...
    fn eq (_self:Ref<bevy::time::Stopwatch>,other:Ref<bevy::time::Stopwatch>,) -> bool {
        let output: bool =<bevy::time::Stopwatch as ::core::cmp::PartialEq::<bevy::time::Stopwatch>>::eq(&_self,&other,).into();
        output
    }
    ...
    fn set_elapsed (mut _self:Mut<bevy::time::Stopwatch>,time:Val<::core::time::Duration>,) -> () {
        let output: () =bevy::time::Stopwatch::set_elapsed(&mut _self,time.into_inner(),).into();
        output
    }
