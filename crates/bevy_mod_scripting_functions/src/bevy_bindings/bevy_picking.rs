                    ...
                    let output: Val<::bevy_picking::backend::prelude::Pickable> = {
                        {
                            let output: Val<
                                ::bevy_picking::backend::prelude::Pickable,
                            > = <::bevy_picking::backend::prelude::Pickable as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_picking::backend::prelude::PointerHits> = {
                        {
                            let output: Val<
                                ::bevy_picking::backend::prelude::PointerHits,
                            > = <::bevy_picking::backend::prelude::PointerHits as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_picking::backend::prelude::PointerId> = {
                        {
                            let output: Val<
                                ::bevy_picking::backend::prelude::PointerId,
                            > = <::bevy_picking::backend::prelude::PointerId as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_picking::pointer::PointerInteraction> = {
                        {
                            let output: Val<
                                ::bevy_picking::pointer::PointerInteraction,
                            > = <::bevy_picking::pointer::PointerInteraction as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
