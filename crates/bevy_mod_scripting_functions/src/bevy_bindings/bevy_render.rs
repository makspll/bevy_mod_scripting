            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::ClearColor>| {
                    let output: Val<::bevy_render::camera::ClearColor> = {
                        {
                            let output: Val<::bevy_render::camera::ClearColor> = <::bevy_render::camera::ClearColor as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::ClearColorConfig>| {
                    let output: Val<::bevy_render::camera::ClearColorConfig> = {
                        {
                            let output: Val<::bevy_render::camera::ClearColorConfig> = <::bevy_render::camera::ClearColorConfig as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::camera::OrthographicProjection> = {
                        {
                            let output: Val<
                                ::bevy_render::camera::OrthographicProjection,
                            > = <::bevy_render::camera::OrthographicProjection as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::camera::OrthographicProjection> = {
                        {
                            let output: Val<
                                ::bevy_render::camera::OrthographicProjection,
                            > = ::bevy_render::camera::OrthographicProjection::default_2d()
                                .into();
                            output
                        }
                    };
                    ...
                    let output: Val<::bevy_render::camera::OrthographicProjection> = {
                        {
                            let output: Val<
                                ::bevy_render::camera::OrthographicProjection,
                            > = ::bevy_render::camera::OrthographicProjection::default_3d()
                                .into();
                            output
                        }
                    };
                    ...
                    let output: Val<::bevy_render::camera::PerspectiveProjection> = {
                        {
                            let output: Val<
                                ::bevy_render::camera::PerspectiveProjection,
                            > = <::bevy_render::camera::PerspectiveProjection as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::Projection>| {
                    let output: Val<::bevy_render::camera::Projection> = {
                        {
                            let output: Val<::bevy_render::camera::Projection> = <::bevy_render::camera::Projection as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::view::visibility::Visibility> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::Visibility,
                            > = <::bevy_render::view::visibility::Visibility as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::sync_world::SyncToRenderWorld> = {
                        {
                            let output: Val<
                                ::bevy_render::sync_world::SyncToRenderWorld,
                            > = <::bevy_render::sync_world::SyncToRenderWorld as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<::bevy_render::primitives::Aabb>| {
                    let output: Val<::bevy_render::primitives::Aabb> = {
                        {
                            let output: Val<::bevy_render::primitives::Aabb> = <::bevy_render::primitives::Aabb as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |minimum: Val<::bevy_math::Vec3>, maximum: Val<::bevy_math::Vec3>| {
                    let output: Val<::bevy_render::primitives::Aabb> = {
                        {
                            let output: Val<::bevy_render::primitives::Aabb> = ::bevy_render::primitives::Aabb::from_min_max(
                                    minimum.into_inner(),
                                    maximum.into_inner(),
                                )
                                .into();
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::primitives::Aabb>| {
                    let output: Val<::bevy_math::Vec3A> = {
                        {
                            let output: Val<::bevy_math::Vec3A> = ::bevy_render::primitives::Aabb::max(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::primitives::Aabb>| {
                    let output: Val<::bevy_math::Vec3A> = {
                        {
                            let output: Val<::bevy_math::Vec3A> = ::bevy_render::primitives::Aabb::min(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::primitives::CascadesFrusta>| {
                    let output: Val<::bevy_render::primitives::CascadesFrusta> = {
                        {
                            let output: Val<::bevy_render::primitives::CascadesFrusta> = <::bevy_render::primitives::CascadesFrusta as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::primitives::CubemapFrusta>| {
                    let output: Val<::bevy_render::primitives::CubemapFrusta> = {
                        {
                            let output: Val<::bevy_render::primitives::CubemapFrusta> = <::bevy_render::primitives::CubemapFrusta as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_render_layers_functions(world: &mut World) {
        ...
        >::new(world)
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = <::bevy_render::view::visibility::RenderLayers as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::intersection(
                                    &_self,
                                    &other,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::layer(n)
                                .into();
                            output
                        }
                    };
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::none()
                                .into();
                            output
                        }
                    };
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::symmetric_difference(
                                    &_self,
                                    &other,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::union(
                                    &_self,
                                    &other,
                                )
                                .into();
            ...
            .register_documented(
                "with",
                |
                    _self: Val<::bevy_render::view::visibility::RenderLayers>,
                    layer: usize|
                {
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::with(
                                    _self.into_inner(),
                                    layer,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_render::view::visibility::RenderLayers> = {
                        {
                            let output: Val<
                                ::bevy_render::view::visibility::RenderLayers,
                            > = ::bevy_render::view::visibility::RenderLayers::without(
                                    _self.into_inner(),
                                    layer,
                                )
                                .into();
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::SubCameraView>| {
                    let output: Val<::bevy_render::camera::SubCameraView> = {
                        {
                            let output: Val<::bevy_render::camera::SubCameraView> = <::bevy_render::camera::SubCameraView as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                    ...
                    other: Ref<::bevy_render::camera::SubCameraView>|
                {
                    let output: bool = {
                        {
                            let output: bool = <::bevy_render::camera::SubCameraView as ::std::cmp::PartialEq<
                                ::bevy_render::camera::SubCameraView,
                            >>::eq(&_self, &other)
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::RenderTarget>| {
                    let output: Val<::bevy_render::camera::RenderTarget> = {
                        {
                            let output: Val<::bevy_render::camera::RenderTarget> = <::bevy_render::camera::RenderTarget as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::camera::NormalizedRenderTarget> = {
                        {
                            let output: Val<
                                ::bevy_render::camera::NormalizedRenderTarget,
                            > = <::bevy_render::camera::NormalizedRenderTarget as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::CustomProjection>| {
                    let output: Val<::bevy_render::camera::CustomProjection> = {
                        {
                            let output: Val<::bevy_render::camera::CustomProjection> = <::bevy_render::camera::CustomProjection as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_render::camera::ScalingMode>| {
                    let output: Val<::bevy_render::camera::ScalingMode> = {
                        {
                            let output: Val<::bevy_render::camera::ScalingMode> = <::bevy_render::camera::ScalingMode as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::storage::ShaderStorageBuffer> = {
                        {
                            let output: Val<
                                ::bevy_render::storage::ShaderStorageBuffer,
                            > = <::bevy_render::storage::ShaderStorageBuffer as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_render::storage::ShaderStorageBuffer> = {
                        {
                            let output: Val<
                                ::bevy_render::storage::ShaderStorageBuffer,
                            > = ::bevy_render::storage::ShaderStorageBuffer::with_size(
                                    size,
