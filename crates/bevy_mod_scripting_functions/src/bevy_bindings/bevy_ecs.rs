    ...
    pub(crate) fn register_entity_functions(world: &mut bevy::ecs::world::World) {
    ...
    pub(crate) fn register_child_of_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            ...
            .register_documented(
                "clone",
                |_self: Ref<bevy::ecs::hierarchy::ChildOf>| {
                    let output: Val<bevy::ecs::hierarchy::ChildOf> = {
                        {
    ...
    pub(crate) fn register_children_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
    ...
    pub(crate) fn register_name_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::name::Name,
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::name::Name>| {
                    let output: Val<bevy::ecs::name::Name> = {
                        {
            ...
            .register_documented(
                "eq",
                |_self: Ref<bevy::ecs::name::Name>, other: Ref<bevy::ecs::name::Name>| {
                    let output: bool = {
                        {
    ...
    pub(crate) fn register_on_add_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::world::OnAdd,
        >::new(world);
        let registry = world
            .get_resource_or_init::<bevy::ecs::reflect::AppTypeRegistry>();
        let mut registry = registry.write();
    ...
    pub(crate) fn register_on_insert_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::world::OnInsert,
        >::new(world);
        let registry = world
            .get_resource_or_init::<bevy::ecs::reflect::AppTypeRegistry>();
        let mut registry = registry.write();
    ...
    pub(crate) fn register_on_remove_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::world::OnRemove,
        >::new(world);
        let registry = world
            .get_resource_or_init::<bevy::ecs::reflect::AppTypeRegistry>();
        let mut registry = registry.write();
    ...
    pub(crate) fn register_on_replace_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::world::OnReplace,
        >::new(world);
        let registry = world
            .get_resource_or_init::<bevy::ecs::reflect::AppTypeRegistry>();
        let mut registry = registry.write();
    ...
    pub(crate) fn register_component_id_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            ...
            .register_documented(
                "clone",
                |_self: Ref<bevy::ecs::component::ComponentId>| {
                    let output: Val<bevy::ecs::component::ComponentId> = {
                        {
    ...
    pub(crate) fn register_default_query_filters_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::entity_disabling::DefaultQueryFilters,
        >::new(world)
            .register_documented(
                "empty",
                || {
                    let output: Val<bevy::ecs::entity_disabling::DefaultQueryFilters> = {
                        {
                            let output: Val<
                                bevy::ecs::entity_disabling::DefaultQueryFilters,
                            > = bevy::ecs::entity_disabling::DefaultQueryFilters::empty()
                                .into();
                            output
                        }
                    };
    ...
    pub(crate) fn register_tick_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            ...
            .register_documented(
                "clone",
                |_self: Ref<bevy::ecs::component::Tick>| {
                    let output: Val<bevy::ecs::component::Tick> = {
                        {
    ...
    pub(crate) fn register_component_ticks_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::component::ComponentTicks>| {
                    let output: Val<bevy::ecs::component::ComponentTicks> = {
                        {
    ...
    pub(crate) fn register_entity_hash_set_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            ...
            .register_documented(
                "clone",
                |_self: Ref<bevy::ecs::entity::hash_set::EntityHashSet>| {
                    let output: Val<bevy::ecs::entity::hash_set::EntityHashSet> = {
                        {
                            let output: Val<
                                bevy::ecs::entity::hash_set::EntityHashSet,
                            > = <bevy::ecs::entity::hash_set::EntityHashSet as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::entity::hash_set::EntityHashSet>| {
                    let output: bool = {
                        {
                            let output: bool = bevy::ecs::entity::hash_set::EntityHashSet::is_empty(
                                    &_self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::entity::hash_set::EntityHashSet>| {
                    let output: usize = {
                        {
                            let output: usize = bevy::ecs::entity::hash_set::EntityHashSet::len(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<bevy::ecs::entity::hash_set::EntityHashSet> = {
                        {
                            let output: Val<
                                bevy::ecs::entity::hash_set::EntityHashSet,
                            > = bevy::ecs::entity::hash_set::EntityHashSet::new().into();
                            output
                        }
                    };
                    output
                    ...
                    let output: Val<bevy::ecs::entity::hash_set::EntityHashSet> = {
                        {
                            let output: Val<
                                bevy::ecs::entity::hash_set::EntityHashSet,
                            > = bevy::ecs::entity::hash_set::EntityHashSet::with_capacity(
                                    n,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_identifier_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::identifier::Identifier>| {
                    let output: Val<bevy::ecs::identifier::Identifier> = {
                        {
    ...
    pub(crate) fn register_entity_hash_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::entity::EntityHash>| {
                    let output: Val<bevy::ecs::entity::EntityHash> = {
                        {
    ...
    pub(crate) fn register_disabled_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
        ...
        >::new(world)
            .register_documented(
                ...
                |_self: Ref<bevy::ecs::entity_disabling::Disabled>| {
                    let output: Val<bevy::ecs::entity_disabling::Disabled> = {
                        {
    ...
    pub(crate) fn register_removed_component_entity_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
                    ...
                    > = {
                        {
                            let output: Val<
                                bevy::ecs::removal_detection::RemovedComponentEntity,
                            > = <bevy::ecs::removal_detection::RemovedComponentEntity as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_system_id_marker_functions(
        world: &mut bevy::ecs::world::World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
            bevy::ecs::system::SystemIdMarker,
        >::new(world);
        let registry = world
            .get_resource_or_init::<bevy::ecs::reflect::AppTypeRegistry>();
        let mut registry = registry.write();
    ...
    pub(crate) fn register_on_despawn_functions(world: &mut bevy::ecs::world::World) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
