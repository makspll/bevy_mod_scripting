        ...
        >::new(world)
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_mesh::Indices>| {
                    let output: bool = {
                        {
                            let output: bool = ::bevy_mesh::Indices::is_empty(&_self)
                                .into();
                            output
                        }
                    };
            ...
            .register_documented(
                ...
                |mut _self: Mut<::bevy_mesh::Indices>, index: u32| {
                    let output: () = {
                        {
                            let output: () = ::bevy_mesh::Indices::push(
                                    &mut _self,
                                    index,
                                )
                                .into();
        ...
        >::new(world)
            ...
            .register_documented(
                ...
                |mut _self: Mut<::bevy_mesh::Mesh>| {
                    let output: () = {
                        {
                            let output: () = ::bevy_mesh::Mesh::compute_normals(
                                    &mut _self,
                                )
                                .into();
                            output
            ...
            .register_documented(
                ...
                |_self: Ref<::bevy_mesh::Mesh>| {
                    let output: bool = {
                        {
                            let output: bool = ::bevy_mesh::Mesh::has_morph_targets(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_circle_mesh_builder_functions(world: &mut World) {
        ...
        >::new(world)
                    ...
                    let output: Val<::bevy_mesh::primitives::CircleMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CircleMeshBuilder,
                            > = ::bevy_mesh::primitives::CircleMeshBuilder::new(
                                    radius,
                                    resolution,
                                )
                                .into();
            ...
            .register_documented(
                "resolution",
                |
                    _self: Val<::bevy_mesh::primitives::CircleMeshBuilder>,
                    resolution: u32|
                {
                    let output: Val<::bevy_mesh::primitives::CircleMeshBuilder> = {
                        {
                    ...
                    let output: Val<::bevy_mesh::primitives::CircularMeshUvMode> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CircularMeshUvMode,
                            > = <::bevy_mesh::primitives::CircularMeshUvMode as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_ellipse_mesh_builder_functions(world: &mut World) {
        ...
        >::new(world)
                    ...
                    let output: Val<::bevy_mesh::primitives::EllipseMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::EllipseMeshBuilder,
                            > = <::bevy_mesh::primitives::EllipseMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::EllipseMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::EllipseMeshBuilder,
                            > = ::bevy_mesh::primitives::EllipseMeshBuilder::new(
                                    half_width,
                                    half_height,
                                    resolution,
                                )
            ...
            .register_documented(
                "resolution",
                |
                    _self: Val<::bevy_mesh::primitives::EllipseMeshBuilder>,
                    resolution: u32|
                {
                    let output: Val<::bevy_mesh::primitives::EllipseMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::EllipseMeshBuilder,
                            > = ::bevy_mesh::primitives::EllipseMeshBuilder::resolution(
                                    _self.into_inner(),
                                    resolution,
                                )
                                .into();
    ...
    pub(crate) fn register_annulus_mesh_builder_functions(world: &mut World) {
        ...
        >::new(world)
                    ...
                    let output: Val<::bevy_mesh::primitives::AnnulusMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::AnnulusMeshBuilder,
                            > = <::bevy_mesh::primitives::AnnulusMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::AnnulusMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::AnnulusMeshBuilder,
                            > = ::bevy_mesh::primitives::AnnulusMeshBuilder::new(
                                    inner_radius,
                                    outer_radius,
                                    resolution,
                                )
            ...
            .register_documented(
                "resolution",
                |
                    _self: Val<::bevy_mesh::primitives::AnnulusMeshBuilder>,
                    resolution: u32|
                {
                    let output: Val<::bevy_mesh::primitives::AnnulusMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::AnnulusMeshBuilder,
                            > = ::bevy_mesh::primitives::AnnulusMeshBuilder::resolution(
                                    _self.into_inner(),
                                    resolution,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::RhombusMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::RhombusMeshBuilder,
                            > = <::bevy_mesh::primitives::RhombusMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::RhombusMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::RhombusMeshBuilder,
                            > = ::bevy_mesh::primitives::RhombusMeshBuilder::new(
                                    horizontal_diagonal,
                                    vertical_diagonal,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::RectangleMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::RectangleMeshBuilder,
                            > = <::bevy_mesh::primitives::RectangleMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::RectangleMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::RectangleMeshBuilder,
                            > = ::bevy_mesh::primitives::RectangleMeshBuilder::new(
                                    width,
                                    height,
                                )
                                .into();
    ...
    pub(crate) fn register_capsule_2_d_mesh_builder_functions(world: &mut World) {
        ...
        >::new(world)
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule2dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule2dMeshBuilder,
                            > = <::bevy_mesh::primitives::Capsule2dMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule2dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule2dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule2dMeshBuilder::new(
                                    radius,
                                    length,
                                    resolution,
                                )
            ...
            .register_documented(
                "resolution",
                |
                    _self: Val<::bevy_mesh::primitives::Capsule2dMeshBuilder>,
                    resolution: u32|
                {
                    let output: Val<::bevy_mesh::primitives::Capsule2dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule2dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule2dMeshBuilder::resolution(
                                    _self.into_inner(),
                                    resolution,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = <::bevy_mesh::primitives::Capsule3dMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule3dMeshBuilder::latitudes(
                                    _self.into_inner(),
                                    latitudes,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule3dMeshBuilder::longitudes(
                                    _self.into_inner(),
                                    longitudes,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule3dMeshBuilder::new(
                                    radius,
                                    height,
                                    longitudes,
                                    latitudes,
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule3dMeshBuilder::rings(
                                    _self.into_inner(),
                                    rings,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::Capsule3dMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::Capsule3dMeshBuilder,
                            > = ::bevy_mesh::primitives::Capsule3dMeshBuilder::uv_profile(
                                    _self.into_inner(),
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = ::bevy_mesh::primitives::CylinderMeshBuilder::anchor(
                                    _self.into_inner(),
                                    anchor.into_inner(),
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = <::bevy_mesh::primitives::CylinderMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = ::bevy_mesh::primitives::CylinderMeshBuilder::new(
                                    radius,
                                    height,
                                    resolution,
                                )
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = ::bevy_mesh::primitives::CylinderMeshBuilder::resolution(
                                    _self.into_inner(),
                                    resolution,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = ::bevy_mesh::primitives::CylinderMeshBuilder::segments(
                                    _self.into_inner(),
                                    segments,
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::CylinderMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::CylinderMeshBuilder,
                            > = ::bevy_mesh::primitives::CylinderMeshBuilder::without_caps(
                                    _self.into_inner(),
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::SphereMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::SphereMeshBuilder,
                            > = <::bevy_mesh::primitives::SphereMeshBuilder as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_mesh::primitives::SphereMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::SphereMeshBuilder,
                            > = ::bevy_mesh::primitives::SphereMeshBuilder::kind(
                                    _self.into_inner(),
                                    kind.into_inner(),
                                )
                                .into();
                    ...
                    let output: Val<::bevy_mesh::primitives::SphereMeshBuilder> = {
                        {
                            let output: Val<
                                ::bevy_mesh::primitives::SphereMeshBuilder,
                            > = ::bevy_mesh::primitives::SphereMeshBuilder::new(
                                    radius,
                                    kind.into_inner(),
                                )
                                .into();
    ...
    pub(crate) fn register_torus_mesh_builder_functions(world: &mut World) {
        ...
        >::new(world)
            ...
            .register_documented(
                "major_resolution",
                |
                    _self: Val<::bevy_mesh::primitives::TorusMeshBuilder>,
                    resolution: usize|
                {
                    let output: Val<::bevy_mesh::primitives::TorusMeshBuilder> = {
                        {
