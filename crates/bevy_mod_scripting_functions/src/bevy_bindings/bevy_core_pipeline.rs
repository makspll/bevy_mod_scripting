                    ...
                    let output: Val<::bevy_core_pipeline::prepass::DepthPrepass> = {
                        {
                            let output: Val<
                                ::bevy_core_pipeline::prepass::DepthPrepass,
                            > = <::bevy_core_pipeline::prepass::DepthPrepass as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_core_pipeline::prepass::NormalPrepass> = {
                        {
                            let output: Val<
                                ::bevy_core_pipeline::prepass::NormalPrepass,
                            > = <::bevy_core_pipeline::prepass::NormalPrepass as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_auto_exposure_compensation_curve_functions(
        world: &mut World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
                    ...
                    let output: Val<::bevy_core_pipeline::bloom::BloomPrefilter> = {
                        {
                            let output: Val<
                                ::bevy_core_pipeline::bloom::BloomPrefilter,
                            > = <::bevy_core_pipeline::bloom::BloomPrefilter as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_core_pipeline::motion_blur::MotionBlur> = {
                        {
                            let output: Val<
                                ::bevy_core_pipeline::motion_blur::MotionBlur,
                            > = <::bevy_core_pipeline::motion_blur::MotionBlur as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
    ...
    pub(crate) fn register_screen_space_transmission_quality_functions(
        world: &mut World,
    ) {
        bevy_mod_scripting_core::bindings::function::namespace::NamespaceBuilder::<
                    ...
                    let output: Val<::bevy_core_pipeline::dof::DepthOfFieldMode> = {
                        {
                            let output: Val<
                                ::bevy_core_pipeline::dof::DepthOfFieldMode,
                            > = <::bevy_core_pipeline::dof::DepthOfFieldMode as ::std::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
