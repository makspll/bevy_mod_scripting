                    ...
                    let output: Val<::bevy_input_focus::tab_navigation::TabIndex> = {
                        {
                            let output: Val<
                                ::bevy_input_focus::tab_navigation::TabIndex,
                            > = <::bevy_input_focus::tab_navigation::TabIndex as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input_focus::tab_navigation::TabGroup> = {
                        {
                            let output: Val<
                                ::bevy_input_focus::tab_navigation::TabGroup,
                            > = <::bevy_input_focus::tab_navigation::TabGroup as ::core::clone::Clone>::clone(
                                    &_self,
                                )
                                .into();
                            output
                    ...
                    let output: Val<::bevy_input_focus::tab_navigation::TabGroup> = {
                        {
                            let output: Val<
                                ::bevy_input_focus::tab_navigation::TabGroup,
                            > = ::bevy_input_focus::tab_navigation::TabGroup::modal()
                                .into();
                            output
                        }
                    };
                    ...
                    let output: Val<::bevy_input_focus::tab_navigation::TabGroup> = {
                        {
                            let output: Val<
                                ::bevy_input_focus::tab_navigation::TabGroup,
                            > = ::bevy_input_focus::tab_navigation::TabGroup::new(order)
                                .into();
                            output
                        }
                    };
