...
impl bevy_mod_scripting_lua::tealr::mlu::ExportInstances for Globals {
    fn add_instances<'lua, T: bevy_mod_scripting_lua::tealr::mlu::InstanceCollector<'lua>>(
        ...
        instances: &mut T,
                ...
                instances.add_instance("LuaComponentTicks", 
                                bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaComponentTicks>::new)?;
    ...
    fn get_doc_fragment(&self) -> Option<Self::DocTarget> {
        Some(bevy_mod_scripting_lua::docs::LuaDocFragment::new("BevyEcsAPI", |tw| {
            tw
                ...
                .process_type::<bevy_mod_scripting_lua::tealr::mlu::UserDataProxy<LuaComponentTicks>>()
