...
#[proxy(
derive(clone,debug),
remote="cursor::CursorIcon",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> cursor::CursorIcon;
}
"#,
			r#"
...
#[proxy(
derive(clone,debug),
remote="event::WindowResized",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowResized;
}
"#,
			r#"
#[lua(
...
pub struct LuaWindowResized{
        ...
        #[lua(output(proxy))]window:bevy_ecs::entity::Entity,
...
#[proxy(
derive(clone,debug),
remote="event::RequestRedraw",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::RequestRedraw;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowCreated",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowCreated;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowCloseRequested",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowCloseRequested;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowClosed",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowClosed;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowDestroyed",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowDestroyed;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::CursorMoved",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::CursorMoved;
}
"#,
			r#"
#[lua(
...
pub struct LuaCursorMoved{
        ...
        #[lua(output(proxy))]position:bevy_math::Vec2,
...
#[proxy(
derive(clone,debug),
remote="event::CursorEntered",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::CursorEntered;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::CursorLeft",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::CursorLeft;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::ReceivedCharacter",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::ReceivedCharacter;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowFocused",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowFocused;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowScaleFactorChanged",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowScaleFactorChanged;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="event::WindowBackendScaleFactorChanged",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowBackendScaleFactorChanged;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="event::FileDragAndDrop",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::FileDragAndDrop;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="event::WindowMoved",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowMoved;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
pub struct LuaWindowMoved{
        ...
        #[lua(output(proxy))]entity:bevy_ecs::entity::Entity,


    
        #[lua(output(proxy))]position:bevy_math::IVec2,
...
#[proxy(
derive(clone,debug),
remote="event::WindowThemeChanged",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> event::WindowThemeChanged;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
pub struct LuaWindowThemeChanged{
        ...
        #[lua(output(proxy))]theme:window::WindowTheme,
...
#[proxy(
derive(clone,debug),
remote="window::PrimaryWindow",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::PrimaryWindow;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::WindowRef",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowRef;
}
"#]
)]
...
#[proxy(
derive(clone,debug),
remote="window::NormalizedWindowRef",
functions[r#"
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::NormalizedWindowRef;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
pub struct LuaWindow{
        ...
        #[lua(output(proxy))]cursor:window::Cursor,


    
        #[lua(output(proxy))]present_mode:window::PresentMode,


    
        #[lua(output(proxy))]mode:window::WindowMode,


    
        #[lua(output(proxy))]position:window::WindowPosition,


    
        #[lua(output(proxy))]resolution:window::WindowResolution,


    
        #[lua(output(proxy))]title:std::string::String,


    
        #[lua(output(proxy))]composite_alpha_mode:window::CompositeAlphaMode,


    
        #[lua(output(proxy))]resize_constraints:window::WindowResizeConstraints,
        ...
        #[lua(output(proxy))]window_level:window::WindowLevel,
        ...
        #[lua(output(proxy))]internal:window::InternalWindowState,
        ...
        #[lua(output(proxy))]ime_position:bevy_math::Vec2,


    
        window_theme:std::option::Option<window::WindowTheme>,
...
#[proxy(
derive(clone,debug),
remote="window::WindowResizeConstraints",
functions[r#"
/// Checks if the constraints are valid.
/// Will output warnings if it isn't.
#[lua(kind = "Method", output(proxy))]
    fn check_constraints(&self) -> window::WindowResizeConstraints;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowResizeConstraints;
}
"#,
			r#"
#[lua(
...
pub struct LuaCursor{
        ...
        #[lua(output(proxy))]icon:cursor::CursorIcon,
        ...
        #[lua(output(proxy))]grab_mode:window::CursorGrabMode,
...
#[proxy(
derive(clone,debug),
remote="window::WindowPosition",
functions[r#"
/// Creates a new [`WindowPosition`] at a position.
#[lua(kind = "Function", output(proxy))]
    fn new(#[proxy] position: bevy_math::IVec2) -> window::WindowPosition;
}
"#,
			r#"
...
#[lua(kind = "Method")]
    fn center(&mut self, #[proxy] monitor: window::MonitorSelection) -> ();
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowPosition;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="window::WindowResolution",
functions[r#"
/// Creates a new [`WindowResolution`].
#[lua(kind = "Function", output(proxy))]
    fn new(logical_width: f32, logical_height: f32) -> window::WindowResolution;
}
"#,
			r#"
...
#[lua(kind = "Method")]
    fn scale_factor_override(&self) -> std::option::Option<f64>;
}
"#,
			r#"
...
#[lua(kind = "Method")]
    fn set_scale_factor_override(
        &mut self,
        scale_factor_override: std::option::Option<f64>,
    ) -> ();
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowResolution;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="window::CursorGrabMode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::CursorGrabMode;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::InternalWindowState",
functions[r#"
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::InternalWindowState;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="window::MonitorSelection",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::MonitorSelection;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::PresentMode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::PresentMode;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::CompositeAlphaMode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::CompositeAlphaMode;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::WindowMode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowMode;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::WindowLevel",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowLevel;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="window::WindowTheme",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> window::WindowTheme;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
impl bevy_mod_scripting::core::hosts::APIProvider for BevyWindowAPIProvider {
    ...
    fn get_doc_fragment(&self) -> Option<Self::DocTarget> {
        Some(LuaDocFragment::new("BevyWindowAPI", |tw| {
            tw
    ...
    fn register_with_app(&self, app: &mut App) {
        ...
        app.register_foreign_lua_type::<cursor::CursorIcon>();
        
        app.register_foreign_lua_type::<event::WindowResized>();
        
        app.register_foreign_lua_type::<event::RequestRedraw>();
        
        app.register_foreign_lua_type::<event::WindowCreated>();
        
        app.register_foreign_lua_type::<event::WindowCloseRequested>();
        
        app.register_foreign_lua_type::<event::WindowClosed>();
        
        app.register_foreign_lua_type::<event::WindowDestroyed>();
        
        app.register_foreign_lua_type::<event::CursorMoved>();
        
        app.register_foreign_lua_type::<event::CursorEntered>();
        
        app.register_foreign_lua_type::<event::CursorLeft>();
        
        app.register_foreign_lua_type::<event::ReceivedCharacter>();
        
        app.register_foreign_lua_type::<event::Ime>();
        
        app.register_foreign_lua_type::<event::WindowFocused>();
        
        app.register_foreign_lua_type::<event::WindowScaleFactorChanged>();
        
        app.register_foreign_lua_type::<event::WindowBackendScaleFactorChanged>();
        
        app.register_foreign_lua_type::<event::FileDragAndDrop>();
        
        app.register_foreign_lua_type::<event::WindowMoved>();
        
        app.register_foreign_lua_type::<event::WindowThemeChanged>();
        
        app.register_foreign_lua_type::<window::PrimaryWindow>();
        
        app.register_foreign_lua_type::<window::WindowRef>();
        
        app.register_foreign_lua_type::<window::NormalizedWindowRef>();
        
        app.register_foreign_lua_type::<window::Window>();
        
        app.register_foreign_lua_type::<window::WindowResizeConstraints>();
        
        app.register_foreign_lua_type::<window::Cursor>();
        
        app.register_foreign_lua_type::<window::WindowPosition>();
        
        app.register_foreign_lua_type::<window::WindowResolution>();
        
        app.register_foreign_lua_type::<window::CursorGrabMode>();
        
        app.register_foreign_lua_type::<window::InternalWindowState>();
        
        app.register_foreign_lua_type::<window::MonitorSelection>();
        
        app.register_foreign_lua_type::<window::PresentMode>();
        
        app.register_foreign_lua_type::<window::CompositeAlphaMode>();
        
        app.register_foreign_lua_type::<window::WindowMode>();
        
        app.register_foreign_lua_type::<window::WindowLevel>();
        
        app.register_foreign_lua_type::<window::WindowTheme>();
