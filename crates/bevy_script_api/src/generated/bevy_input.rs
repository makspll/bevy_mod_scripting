...
#[proxy(
derive(clone,debug),
remote="gamepad::Gamepad",
functions[r#"
/// Creates a new [`Gamepad`].
#[lua(kind = "Function", output(proxy))]
    fn new(id: usize) -> gamepad::Gamepad;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::Gamepad;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadInfo",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadInfo;
}
"#,
			r#"
#[lua(
...
pub struct LuaGamepadInfo{
        ...
        #[lua(output(proxy))]name:std::string::String,
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadButtonType",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadButtonType;
}
"#,
			r#"
#[lua(
...
#[lua(kind = "Function", output(proxy))]
    fn new(
        ...
        #[proxy]
        button_type: gamepad::GamepadButtonType,
    ) -> gamepad::GamepadButton;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadButton;
}
"#,
			r#"
#[lua(
...
pub struct LuaGamepadButton{
        ...
        #[lua(output(proxy))]gamepad:gamepad::Gamepad,


    
        #[lua(output(proxy))]button_type:gamepad::GamepadButtonType,
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadAxisType",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadAxisType;
}
"#,
			r#"
#[lua(
...
#[lua(kind = "Function", output(proxy))]
    fn new(
        ...
        gamepad: gamepad::Gamepad,
        #[proxy]
        axis_type: gamepad::GamepadAxisType,
    ) -> gamepad::GamepadAxis;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadAxis;
}
"#,
			r#"
#[lua(
...
pub struct LuaGamepadAxis{
        ...
        #[lua(output(proxy))]axis_type:gamepad::GamepadAxisType,
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadSettings",
functions[]
)]
...
pub struct LuaGamepadSettings{
        ...
        #[lua(output(proxy))]default_button_settings:gamepad::ButtonSettings,


    
        #[lua(output(proxy))]default_axis_settings:gamepad::AxisSettings,


    
        #[lua(output(proxy))]default_button_axis_settings:gamepad::ButtonAxisSettings,


    
        button_settings:bevy_utils::hashbrown::HashMap<gamepad::GamepadButton, gamepad::ButtonSettings>,


    
        axis_settings:bevy_utils::hashbrown::HashMap<gamepad::GamepadAxis, gamepad::AxisSettings>,


    
        button_axis_settings:bevy_utils::hashbrown::HashMap<gamepad::GamepadButton, gamepad::ButtonAxisSettings>,
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::ButtonSettings;
}
"#]
)]
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::AxisSettings;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="gamepad::ButtonAxisSettings",
functions[r#"
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::ButtonAxisSettings;
}
"#]
)]
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadConnection",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadConnection;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadConnectionEvent",
functions[r#"
#[lua(kind = "Function", output(proxy))]
    fn new(
        #[proxy]
        gamepad: gamepad::Gamepad,
        #[proxy]
        connection: gamepad::GamepadConnection,
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadConnectionEvent;
}
"#,
			r#"
#[lua(
...
pub struct LuaGamepadConnectionEvent{
        ...
        #[lua(output(proxy))]connection:gamepad::GamepadConnection,
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadAxisChangedEvent",
functions[r#"
#[lua(kind = "Function", output(proxy))]
    fn new(
        #[proxy]
        ...
        axis_type: gamepad::GamepadAxisType,
        value: f32,
    ) -> gamepad::GamepadAxisChangedEvent;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadAxisChangedEvent;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadButtonChangedEvent",
functions[r#"
#[lua(kind = "Function", output(proxy))]
    fn new(
        #[proxy]
...
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadButtonChangedEvent;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="gamepad::GamepadEvent",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> gamepad::GamepadEvent;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="keyboard::KeyboardInput",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> keyboard::KeyboardInput;
}
"#,
			r#"
#[lua(
...
pub struct LuaKeyboardInput{
        ...
        key_code:std::option::Option<keyboard::KeyCode>,


    
        #[lua(output(proxy))]state:ButtonState,
...
#[proxy(
derive(clone,debug),
remote="keyboard::KeyCode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> keyboard::KeyCode;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="keyboard::ScanCode",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> keyboard::ScanCode;
}
"#,
			r#"
#[lua(
    ...
    fn eq(&self, #[proxy] other: &keyboard::ScanCode) -> bool;
}
"#,
			r#"
#[lua(kind = "Method", as_trait = "std::cmp::Eq")]
...
#[proxy(
derive(clone,debug),
remote="mouse::MouseButtonInput",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> mouse::MouseButtonInput;
}
"#,
			r#"
#[lua(
...
pub struct LuaMouseButtonInput{
        ...
        #[lua(output(proxy))]button:mouse::MouseButton,
...
#[proxy(
derive(clone,debug),
remote="mouse::MouseButton",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> mouse::MouseButton;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="mouse::MouseMotion",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> mouse::MouseMotion;
}
"#,
			r#"
#[lua(
...
pub struct LuaMouseMotion{
        ...
        #[lua(output(proxy))]delta:bevy_math::Vec2,
...
#[proxy(
derive(clone,debug),
remote="mouse::MouseScrollUnit",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> mouse::MouseScrollUnit;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="mouse::MouseWheel",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> mouse::MouseWheel;
}
"#,
			r#"
#[lua(
...
pub struct LuaMouseWheel{
        ...
        #[lua(output(proxy))]unit:mouse::MouseScrollUnit,
...
#[proxy(
derive(clone,debug),
remote="touch::TouchInput",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> touch::TouchInput;
}
"#,
			r#"
#[lua(
...
pub struct LuaTouchInput{
        ...
        #[lua(output(proxy))]phase:touch::TouchPhase,
        ...
        force:std::option::Option<touch::ForceTouch>,
...
#[proxy(
derive(clone,debug),
remote="touch::ForceTouch",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> touch::ForceTouch;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="touch::TouchPhase",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> touch::TouchPhase;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="touchpad::TouchpadMagnify",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> touchpad::TouchpadMagnify;
}
"#,
			r#"
#[lua(
...
#[proxy(
derive(clone,debug),
remote="touchpad::TouchpadRotate",
functions[r#"
#[lua(kind = "Method", as_trait = "std::clone::Clone", output(proxy))]
    fn clone(&self) -> touchpad::TouchpadRotate;
}
"#,
			r#"
#[lua(
...
impl bevy_mod_scripting::core::hosts::APIProvider for BevyInputAPIProvider {
    ...
    fn get_doc_fragment(&self) -> Option<Self::DocTarget> {
        Some(LuaDocFragment::new("BevyInputAPI", |tw| {
            tw
    ...
    fn register_with_app(&self, app: &mut App) {
        ...
        app.register_foreign_lua_type::<gamepad::Gamepad>();
        
        app.register_foreign_lua_type::<gamepad::GamepadInfo>();
        
        app.register_foreign_lua_type::<gamepad::GamepadButtonType>();
        
        app.register_foreign_lua_type::<gamepad::GamepadButton>();
        
        app.register_foreign_lua_type::<gamepad::GamepadAxisType>();
        
        app.register_foreign_lua_type::<gamepad::GamepadAxis>();
        
        app.register_foreign_lua_type::<gamepad::GamepadSettings>();
        
        app.register_foreign_lua_type::<gamepad::ButtonSettings>();
        
        app.register_foreign_lua_type::<gamepad::AxisSettings>();
        
        app.register_foreign_lua_type::<gamepad::ButtonAxisSettings>();
        
        app.register_foreign_lua_type::<gamepad::GamepadConnection>();
        
        app.register_foreign_lua_type::<gamepad::GamepadConnectionEvent>();
        
        app.register_foreign_lua_type::<gamepad::GamepadAxisChangedEvent>();
        
        app.register_foreign_lua_type::<gamepad::GamepadButtonChangedEvent>();
        
        app.register_foreign_lua_type::<gamepad::GamepadEvent>();
        
        app.register_foreign_lua_type::<keyboard::KeyboardInput>();
        
        app.register_foreign_lua_type::<keyboard::KeyCode>();
        
        app.register_foreign_lua_type::<keyboard::ScanCode>();
        
        app.register_foreign_lua_type::<mouse::MouseButtonInput>();
        
        app.register_foreign_lua_type::<mouse::MouseButton>();
        
        app.register_foreign_lua_type::<mouse::MouseMotion>();
        
        app.register_foreign_lua_type::<mouse::MouseScrollUnit>();
        
        app.register_foreign_lua_type::<mouse::MouseWheel>();
        
        app.register_foreign_lua_type::<touch::TouchInput>();
        
        app.register_foreign_lua_type::<touch::ForceTouch>();
        
        app.register_foreign_lua_type::<touch::TouchPhase>();
        
        app.register_foreign_lua_type::<touchpad::TouchpadMagnify>();
        
        app.register_foreign_lua_type::<touchpad::TouchpadRotate>();
        
        app.register_foreign_lua_type::<ButtonState>();
