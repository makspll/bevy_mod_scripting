...
impl_script_newtype!{
	...
	bevy_sprite::mesh2d::Mesh2dHandle : 
	Methods
	(
...
impl_script_newtype!{
	...
	(
		...
		default() -> Wrapped(Rect),

		clone(&self:) -> Wrapped(Rect),

		eq(&self:Wrapped(&Rect)) -> Raw(bool),
...
impl_script_newtype!{
	#[languages(on_feature(lua))]
	bevy_render::mesh::SkinnedMesh : 
	Methods
	(
		default() -> Wrapped(SkinnedMesh),

		clone(&self:) -> Wrapped(SkinnedMesh),
...
impl bevy_mod_scripting_lua::tealr::mlu::ExportInstances for BevyAPIGlobals{
	fn add_instances<'lua, T: bevy_mod_scripting_lua::tealr::mlu::InstanceCollector<'lua>>(self, instances: &mut T) -> bevy_mod_scripting_lua::tealr::mlu::mlua::Result<()>
	{
		...
		instances.add_instance("Rect", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaRect>::new)?;
		...
		instances.add_instance("SkinnedMesh", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaSkinnedMesh>::new)?;
		...
		instances.add_instance("Vec3A", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaVec3A>::new)?;
		instances.add_instance("Vec4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaVec4>::new)?;
		instances.add_instance("BVec2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaBVec2>::new)?;
		instances.add_instance("BVec3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaBVec3>::new)?;
		instances.add_instance("BVec4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaBVec4>::new)?;
		instances.add_instance("BVec3A", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaBVec3A>::new)?;
		instances.add_instance("BVec4A", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaBVec4A>::new)?;
		instances.add_instance("DVec2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDVec2>::new)?;
		instances.add_instance("DVec3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDVec3>::new)?;
		instances.add_instance("DVec4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDVec4>::new)?;
		instances.add_instance("IVec2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaIVec2>::new)?;
		instances.add_instance("IVec3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaIVec3>::new)?;
		instances.add_instance("IVec4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaIVec4>::new)?;
		instances.add_instance("UVec2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaUVec2>::new)?;
		instances.add_instance("UVec3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaUVec3>::new)?;
		instances.add_instance("UVec4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaUVec4>::new)?;
		instances.add_instance("Mat3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaMat3>::new)?;
		instances.add_instance("Mat2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaMat2>::new)?;
		instances.add_instance("Mat3A", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaMat3A>::new)?;
		instances.add_instance("Mat4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaMat4>::new)?;
		instances.add_instance("DMat2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDMat2>::new)?;
		instances.add_instance("DMat3", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDMat3>::new)?;
		instances.add_instance("DMat4", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDMat4>::new)?;
		instances.add_instance("Affine2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaAffine2>::new)?;
		instances.add_instance("Affine3A", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaAffine3A>::new)?;
		instances.add_instance("DAffine2", bevy_mod_scripting_lua::tealr::mlu::UserDataProxy::<LuaDAffine2>::new)?;
...
impl APIProvider for LuaBevyAPIProvider{
	...
	fn get_doc_fragment(&self) -> Option<Self::DocTarget>	{
		Some(LuaDocFragment::new(|tw|		{
			...
			.process_type::<bevy_mod_scripting_lua::tealr::mlu::UserDataProxy<LuaSkinnedMesh>>()
