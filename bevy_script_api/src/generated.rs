...
impl_script_newtype! {
    ...
    (
        ...
        physical_size(&self:Raw(f32),Raw(f32)) -> Wrapped(Vec2),

        ///Returns the logical pixel coordinates of the UI node, based on its [`GlobalTransform`].
        logical_rect(&self:Wrapped(&GlobalTransform)) -> Wrapped(Rect),

        ///Returns the physical pixel coordinates of the UI node, based on its [`GlobalTransform`] and the scale factor.
        physical_rect(&self:Wrapped(&GlobalTransform),Raw(f32),Raw(f32)) -> Wrapped(Rect),
...
impl_script_newtype! {
    ...
    (
        ...
        with_justify(self:Wrapped(JustifyText)) -> self,
...
impl_script_newtype! {
    ...
    (
        ...
        ///```
        fraction_remaining(&self:) -> Raw(f32),
...
impl_script_newtype! {
    ...
    + BinOps
    (
        self Div Raw(f32) -> Wrapped(ScalingMode),
        self Mul Raw(f32) -> Wrapped(ScalingMode),
    )
    + UnaryOps
    (
    )
...
impl APIProvider for LuaBevyAPIProvider {
    ...
    fn register_with_app(&self, app: &mut App) {
        ...
        app.register_foreign_lua_type::<JustifyText>();
        ...
        app.register_foreign_lua_type::<TextureAtlas>();
