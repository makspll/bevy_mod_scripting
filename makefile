...
make_json_files:
	...
	rustup run nightly cargo rustdoc -p bevy_math@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_transform@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_sprite@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_ui@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_animation@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_core@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_core_pipeline@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_gltf@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_hierarchy@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_text@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_time@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_utils@0.8.0-dev --  -Zunstable-options --output-format json && \
	rustup run nightly cargo rustdoc -p bevy_reflect@0.8.0-dev --  -Zunstable-options --output-format json && \
